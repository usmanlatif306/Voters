<section>
    ...
    <form wire:submit="store" class="mt-6 space-y-6">
        ...
        {{-- <div>
            ...
            <x-text-input wire:model="gender" id="gender" name="gender" type="text" class="mt-1 block w-full" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Save Voter') }}</x-primary-button>
...
@script
    <script>
        $wire.on('voter-created', () => {
            document.getElementById("family_number").focus()
        });
    </script>
@endscript
