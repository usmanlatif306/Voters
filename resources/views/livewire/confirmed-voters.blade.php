<div class="mt-5">
    <div class="mb-2 flex items-center gap-4">
        <input type="text"
            class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
        ...
        <label for="casted" class="inline-flex items-center">
            <input wire:model.live="casted" id="casted" type="checkbox"
                class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
            <span class="ms-2 text-sm text-gray-600">{{ __('Casted') }}</span>
        </label>
        <label for="remaining" class="inline-flex items-center">
            <input wire:model.live="not_casted" id="remaining" type="checkbox"
                class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
            <span class="ms-2 text-sm text-gray-600">{{ __('Remaining') }}</span>
        </label>
    </div>
